...
```{r}
model <- lm(logreturn ~ Book.to.Market.Ratio.log + Sales.Per.Share.log + Return.On.Equity.log + Operating.Profit.Margin.log + Receivable.Turnover.log + Total.Debt.Ratio.log+Current.Ratio.log, data=train[train$Fiscal.Year == 2016,])
summary(model)
